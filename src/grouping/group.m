...
saveas(ui1, '../../output/crosstab_kmeans', 'svg');
...
saveas(ui2, '../../output/crosstab_single_link', 'svg');
...
saveas(ui3, '../../output/crosstab_avg_link', 'svg');
...
saveas(ui4, '../../output/crosstab_complete_link', 'svg');
