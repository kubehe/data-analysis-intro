...
title("Wykresy punktowe atrybut�w z podzia�em wg atrybutu decyzyjnego");
...
title("Wykresy punktowe atrybut�w 4, 6 i 9 z grupowaniem (average linkage)");
set(gcf, 'PaperUnits', 'centimeters', 'PaperPosition', [0 0 25 15]);
