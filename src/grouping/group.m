...
saveas(gcf, '../../output/plotmat-classes', 'svg');
...
set(gcf, 'PaperUnits', 'centimeters', 'PaperPosition', [0 0 35 20]);
saveas(gcf, '../../output/plotmat-group469-kmeans', 'svg');
...
set(gcf, 'PaperUnits', 'centimeters', 'PaperPosition', [0 0 25 15]);
saveas(gcf, '../../output/plotmat-group469-avglink', 'svg');
